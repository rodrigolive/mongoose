...
Use the C<ArrayRef> Any::Moose type.
...
Use L<Mongoose::Class> instead of C<Any::Moose>.
...
Support for the FileHandle Any::Moose type is done making use
of L<Any::MooseDB::GridFS>. 
