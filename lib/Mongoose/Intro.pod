...
of Any::Moose into one of the hottest new databases out there: MongoDB.
...
=head2 Any::Moose classes

Create some Any::Moose classes to start using Mongoose;
...
To make your Any::Moose classes "Mongoable", all they need is to consume either
...
There are two roles to make your Any::Moose class a Mongoose document:
...
Read the L<http://www.mongodb.org/display/DOCS/Schema+Design#SchemaDesign-Embedvs.Reference|MongoDB docs>
...
Mongoose roles are L<Any::MooseX::Role::Parameterized|role parameterized>
...
That way, with every insert or update, the C<drivers_license> field
is checked with the help of the C<upsert> feature of Mongo.
